...
def generate_launch_description():
    ...
    gz_ros2_bridge = Node(
        ...
        remappings=[
            ...
            ('/stereo_camera/left/image_raw', 'anhc_bot/stereo_camera/left/image_raw'),
            ('/stereo_camera/right/image_raw', 'anhc_bot/stereo_camera/right/image_raw'),
            ('/imu', 'anhc_bot/imu'),
            ('/cmd_vel', 'anhc_bot/cmd_vel'),
            ('kinect_camera/camera_info', 'anhc_bot/kinect_camera/camera_info'),
            ('stereo_camera/left/camera_info', 'anhc_bot/stereo_camera/left/camera_info'),
            ('stereo_camera/right/camera_info', 'anhc_bot/stereo_camera/right/camera_info'),
            ('/kinect_camera/points', 'anhc_bot/kinect_camera/points'),
        ]
    )
    ...
    transform_publisher = Node(
        ...
        arguments=[
            ...
            "--child-frame-id", "anhc_bot/base_footprint/kinect_camera"
        ]
    )
